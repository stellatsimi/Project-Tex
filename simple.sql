...
INSERT INTO user VALUES (null, '123', 'employee', 'sta', 'kaz');
...
SET prod_inv_buy_price = '15.00' WHERE prod_inv_name = 'ΟΛΥΜΠΟΣ τυρί κεφαλοτύρι πρόβειο τριμμένο 150gr' AND prod_inv_id = '1';
UPDATE user
SET password = '15'  WHERE user_id = '2';
SELECT * FROM log_update;
DELETE FROM user WHERE user_id = '1';

INSERT INTO employee VALUES (2, 12343, 745347858, 'stamatis', 1300);
SELECT * FROM employee;

INSERT INTO user VALUES(null, '12345', 'employee', 'kaliopi', 'kaliopi');

INSERT INTO employee (employee_id, afm, phone, address, salary)
VALUES (3, 1234567890, 2101234567, 'Οδός Παράδεισος 1, Πόλη', 2500.00);
...
-- Συνέχισε στα επόμενα prod_rec_id...
-- Προϊόντα για prod_rec_id = 7
INSERT INTO product_Receipt (prod_rec_name, prod_rec_id, prod_rec_quantity, prod_rec_quantity_type)
VALUES
('Λάδι', 7, 1, 'λίτρα'),
...
-- Προϊόντα για prod_rec_id = 17 (συνέχεια)
INSERT INTO product_Receipt (prod_rec_name, prod_rec_id, prod_rec_quantity, prod_rec_quantity_type)
VALUES
('1', 17, 1, 'λίτρα'),
