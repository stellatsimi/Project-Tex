...
public class mainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/simple/LOGO.jpg"))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(jLabel17, javax.swing.GroupLayout.DEFAULT_SIZE, 1137, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addGap(61, 61, 61)
                        .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jComboStatistics, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        try{
               ...
               PreparedStatement statement;
                ...
                if(log_action_jcb.getSelectedItem().equals("INSERT")){
                    String[] columns = {"log_ins_id", "log_ins_action", "log_ins_table", "log_ins_new_record", "log_ins_change_time"};
                ...
                if(log_action_jcb.getSelectedItem().equals("UPDATE")){
                    ...
                    String[] columns = {"log_up_id", "log_up_action", "log_up_table", "log_up_col_name", "log_up_pk_value", "log_up_old_value", "log_up_new_value", "log_up_change_time"};
                    DefaultTableModel log_table_model = new DefaultTableModel(columns, 0);
                ...
                if(log_action_jcb.getSelectedItem().equals("DELETE")){
                    ...
                    //DefaultTableModel tableModel = new DefaultTableModel(columnNames.toArray(), 0);
                    //DefaultTableModel log_table = new DefaultTableModel(columnNames.toArray(), 0);
                    String[] columns = {"log_del_id", "log_del_action", "log_del_table", "log_del_change_time"};
                    DefaultTableModel log_table_model = new DefaultTableModel(columns, 0);
  ...
  private boolean isValidQuantity(String quantity) {
        ...
        try{
               ...
               PreparedStatement statement;
                ...
                if(log_action_jcb.getSelectedItem().equals("DELETE")){
                    ...
                    //DefaultTableModel tableModel = new DefaultTableModel(columnNames.toArray(), 0);
                    //DefaultTableModel log_table = new DefaultTableModel(columnNames.toArray(), 0);
                    String[] columns = {"log_del_id", "log_del_action", "log_del_table", "log_del_value", "log_del_change_time"};
                    DefaultTableModel log_table_model = new DefaultTableModel(columns, 0);
                    String sql8 = "SELECT * FROM log_delete WHERE log_del_table=?";
                    statement = myConn.prepareStatement(sql8);
                    statement.setString(1, (String)log_table_jcb.getSelectedItem());
    ...
    private void jComboStatisticsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jComboStatisticsMouseClicked
        ...
        for (Component component : jPanel16.getComponents()) {
            if (!component.equals(jComboStatistics) && !component.equals(label2) && !component.equals(jButton15)) {
                jPanel16.remove(component);
            }
        }
        if (selected_item.equals("top products")) {
            runPythonScript(path + "top_products.py");
