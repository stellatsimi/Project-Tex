...
public class mainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("ΚΩΔΙΚΟΣ ΧΡΗΣΤΗ");
        ...
        log_table_jcb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "user", "owner", "employee", "product_Storage", "supplier", "invoice", "product_Invoice", "customer", "receiptproduct_Receipt", "orders", "product_Order", "Z", "scanner" }));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(41, 41, 41)
                        .addComponent(jProductSearchAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(50, 50, 50))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        //runPythonScript("C:\\Users\\USER\\Desktop\\SIMPLE\\daily_plots.py");
        try {
            // Load the plot image from file
            BufferedImage originalImage = ImageIO.read(new File("C:\\Users\\USER\\Desktop\\SIMPLE\\daily_plots.png"));
        ...
        try{
               ...
               DatabaseMetaData metaData = myConn.getMetaData();
                ...
                if(log_action_jcb.getSelectedItem().equals("INSERT")){
                    ...
                    DefaultTableModel log_table = new DefaultTableModel(5, 0);
    ...
    int receiptId = getLatestReceiptId();
     ...
     int table_rows = model.getRowCount();
        ...
        try{
                ...
                for(int i = 0; i<table_rows; i++){
                    PreparedStatement statement1;
                    String sql10 = "SELECT prod_rec_name, prod_rec_quantity FROM product_Receipt WHERE prod_rec_id=? AND prod_rec_name=?";
                    statement1 = myConn.prepareStatement(sql10);
                    statement1.setInt(1, receiptId);
                    statement1.setString(2, model.getValueAt(i,0).toString());
                    myRs = statement1.executeQuery();
                    
                    if(myRs.next()){
                        String sql11 = "UPDATE product_Receipt SET prod_rec_quantity=? WHERE prod_rec_id=? AND prod_rec_name=?";
                        PreparedStatement statement2;
                        statement2 = myConn.prepareStatement(sql11);
                        statement2.setInt(1, myRs.getInt("prod_rec_quantity")+1);
                        statement2.setString(2, model.getValueAt(i,0).toString());
                        statement2.setInt(3, receiptId);
                        statement2.execute();
                    } else{
                        String sql12 = "INSERT INTO product_Receipt VALUES(?,?,?,?)";
                        PreparedStatement statement3;
                        statement3 = myConn.prepareStatement(sql12);
                        statement3.setString(1, model.getValueAt(i,0).toString());
                        statement3.setInt(2, receiptId);
                        statement3.setInt(3, 1);
                        statement3.setString(4, model.getValueAt(i,4).toString());
                    }
                }
                
                String sql13 = "SELECT SUM(pr.prod_rec_quantity * ps.prod_stor_price) AS total_cost " +
                ...
                statement4 = myConn.prepareStatement(sql13);
                statement4.setInt(1, receiptId);
                myRs = statement4.executeQuery();
                
                float cost = 0.0f;
                
                if(myRs.next()){
                    cost = myRs.getFloat("total_cost");
                    jLabel9.setText(String.format("%.2f €", cost));
                }
                
                String sql14 = "SELECT prod_rec_name, prod_rec_quantity FROM product_Receipt WHERE prod_rec_id=?";
                PreparedStatement statement5;
                statement5 = myConn.prepareStatement(sql14);
                statement5.setInt(1, receiptId);
                myRs = statement5.executeQuery(sql14);
                
                if(myRs.next()){
                    String sql15 = "UPDATE product_Storage SET prod_stor_quantity=OLD.prod_stor_quantity-?";
                    PreparedStatement statement6;
                    statement6 = myConn.prepareStatement(sql15);
                    statement6.setInt(1, myRs.getInt("prod_rec_quantity"));
                    statement6.execute();                   
                }
...
private void downloadReceipt() throws ClassNotFoundException, SQLException, IOException{
    ...
    myConn = getDataBaseCon();
        ...
        String productQuery = "SELECT pr.prod_rec_name, pr.prod_rec_quantity, pr.prod_rec_quantity_type, ps.prod_stor_price, ps.prod_stor_fpa " +
                              "FROM product_Receipt pr " +
                              "JOIN product_Storage ps ON pr.prod_rec_name = ps.prod_stor_name " +
                              "WHERE pr.prod_rec_id = ?";
            ...
            try (ResultSet receiptResultSet = receiptStatement.executeQuery();
                ...
                if (receiptResultSet.next()) {
                    ...
                    while (productResultSet.next()) {
                        ...
                        float price = productResultSet.getFloat("ptod_stor_price");
...
private boolean isValidFpa(String fpa) {
  ...
  private boolean isValidQuantity(String quantity) {
    ...
    private void jButton14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton14MouseClicked
        // TODO add your handling code here:
        runPythonScript("C:\\Users\\USER\\Desktop\\SIMPLE\\metro_web.py");
        runPythonScript("C:\\Users\\USER\\Desktop\\SIMPLE\\markt_web.py");
        ResultSet myRs = null;
        Statement st = null;
    ...
    private void jStaffMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jStaffMouseClicked
        try {
            ...
            myConn = getDataBaseCon();
            Statement statement = myConn.createStatement();
            ResultSet resultSet = statement.executeQuery("SELECT u.user_id, u.name, u.surname, e.afm, e.phone, e.address, e.salary FROM user u INNER JOIN employee e ON u.user_id = e.employee_id");
            ...
            while (resultSet.next()) {
                ...
                Object[] rowData = {userId, name, surname, afm, phone, address, salary};
                tableModel.addRow(rowData);
                
                
                // Add some space at the top of the table
                ...
                // Add the button panel to jPanel11
    ...
    Connection myConn;
    myConn = getDataBaseCon();
        try (PreparedStatement searchProductStatement = myConn.prepareStatement(searchProduct)) {
